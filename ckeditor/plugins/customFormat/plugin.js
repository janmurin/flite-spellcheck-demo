...
(function () {
    ...
    CKEDITOR.plugins.add('customFormat', {
        requires: 'richcombo',
        ...
        init: function (editor) {
            ...
            editor.ui.addRichCombo('Format', {
                ...
                if (editor.config.customStyles) {
                        elementPath = editor.elementPath();
                        var parentName = elementPath != null && elementPath.block != null ?
                            elementPath.block.$.parentNode.nodeName : "";
                        var selection = editor.getSelection();
                        // var element = selection.getStartElement();
                        // element.$.innerText = element.$.innerText.replace('\n', '');
                        // commented out this, because it was removing nested <span elements (mergefields, and possibly inline comment elements)

                        selection.selectElement(elementPath.block);
                        if (editor.config.fontFamily_styles && editor.config.fontSize_styles) {
                            editor.applyStyle(editor.config.fontFamily_styles[editor.config.customStyles[value]['fontFamily']]);
                            editor.applyStyle(editor.config.fontSize_styles[editor.config.customStyles[value]['fontSize']]);
                        }
                        if (parentName === 'TD') {
